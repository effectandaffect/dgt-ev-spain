...
export default function DailyBEVChart({ data2025, data2026, currentYear }: Props) {
      ...
      {chartData.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height={260}>
          <BarChart data={chartData} margin={{ top: 4, right: 8, left: -10, bottom: 0 }}>
            ...
            <Tooltip
              formatter={(v: number) => [v.toLocaleString("es-ES"), "Matriculaciones BEV"]}
              labelFormatter={(l) => {
              ...
              cursor={{ fill: "#f0fdf4" }}
            />
            <Bar dataKey="count" fill="#22c55e" radius={[3, 3, 0, 0]} maxBarSize={32} />
          </BarChart>
        </ResponsiveContainer>
      )}
    </div>
